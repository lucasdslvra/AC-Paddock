...
interface AdminViewProps {
  /** US-G1 — le formulaire de création de soirée n'est visible que des admins. */
  isAdmin: boolean;
}
      ...
      <div className="grid grid-cols-1 gap-[18px] p-5 lg:grid-cols-[1fr_330px]">
        ...
        <div className="flex flex-col gap-3">
          {/* US-G1 — cahier §2.6 : c'est l'admin/organisateur qui crée les soirées.
              Masqué pour les autres, et refusé par POST /api/soirees de toute façon. */}
          {isAdmin && <SoireeCreateForm />}
